 ...
 * @throws {Error} If there was an error terminating the sessions.
 */
const changeWebhookUrlSession = async (req, res) => {
	// #swagger.summary = 'Atualiza a webhookUrl da essao'
	// #swagger.description = 'Atualiza a webhookUrl da essao'
	try {
		const sessionId = req.params.sessionId;
		const webhookUrl = req.body.webhookUrl;
